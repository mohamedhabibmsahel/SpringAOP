...
import com.esprit.examen.entities.ReglementDto;
...
public class ReglementRestController {
    ...
    public Reglement addReglement(@RequestBody ReglementDto r) {
        ...
        reglement.setMontantPaye(r.getMontantPaye());
        reglement.setMontantRestant(r.getMontantRestant());
        reglement.setPayee(r.getPayee());
        reglement.setDateReglement(r.getDateReglement());
